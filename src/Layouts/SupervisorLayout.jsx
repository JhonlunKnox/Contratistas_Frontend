...
export default function SupervisorLayout() {
  ...
  if (!token || !storedUser || storedUser.rol !== 'supervisor') {
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, #F5A623 0%, #F5C020 100%)",
                  display: "flex",
                  alignItems: "center",
          ...
          >
            ...
            <input
              ...
              onFocus={(e) => {
                ...
                e.target.style.boxShadow = `0 0 0 3px ${colors.focusShadow}`;
              }}
              onBlur={(e) => {
...
function BellIcon() {
  return (
    ...
    >
      <path
        d="M7 2C5.34 2 4 3.34 4 5v2.5L2.5 9.5h9L10 7.5V5c0-1.66-1.34-3-3-3z"
        stroke="currentColor"
        strokeWidth="1.3"
      />
      <path
        d="M5.5 9.5c0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5"
        stroke="currentColor"
        strokeWidth="1.3"
      />
    </svg>
