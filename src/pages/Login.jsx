...
const platforms = [
  {
    ...
    icon: (
      ...
      >
        ...
        />
        <path
          d="M11 8V6.5A2.5 2.5 0 0 1 13.5 4h5A2.5 2.5 0 0 1 21 6.5V8"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      ...
      >
        ...
        <path
          d="M6 27c0-5.52 4.48-10 10-10s10 4.48 10 10"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M16 4l3 7h7l-5.5 4.5 2 7L16 19l-6.5 3.5 2-7L6 11h7z"
          stroke="currentColor"
          strokeWidth="1.8"
          strokeLinejoin="round"
        />
...
const ROL_ROUTES = {
  contratista: "/empleado/dashboard",
  supervisor: "/supervisor/dashboard",
  gerente: "/admin/registrar",
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(ROL_ROUTES[data.user.rol] || "/");
    } catch {
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, #0a1628 0%, #0d2145 50%, #0a1628 100%)",
        }}
      />
      <div
        style={{
      ...
      >
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          >
            <p
              style={{
                margin: 0,
                color: `${selectedPlatform.color}CC`,
                fontSize: typography.xs,
                textAlign: "center",
              }}
            >
        ...
        >
          ...
          />
          <span
            style={{ color: "rgba(255,255,255,0.25)", fontSize: typography.xs }}
          >
            Inicia sesión
          </span>
          <div
        ...
        <form onSubmit={handleSubmit} style={{ textAlign: "left" }}>
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              onFocus={(e) => {
                e.target.style.borderColor = selectedPlatform.color;
                e.target.style.boxShadow = `0 0 0 3px ${selectedPlatform.color}33`;
              }}
              onBlur={(e) => {
          ...
          >
            ...
            >
              <input
                ...
                style={{ accentColor: selectedPlatform.color }}
              />
              Recordarme
            </label>
            <button
